...
(function(html) {
    ...
    * ------------------------------------------------------ */
    const ssCountdown = function() {
        const countdown = () => {
            const countDate = new Date('October 25, 2025 13:00:00').getTime();
            ...
            // Actualiza el contador en la sección de introducción
            document.getElementById('intro-days').innerText = textDay;
            document.getElementById('intro-hours').innerText = textHour;
            document.getElementById('intro-minutes').innerText = textMinute;
            document.getElementById('intro-seconds').innerText = textSecond;
        };
